...
if __name__ == '__main__':
    model_path = r'E:\RTDETR-main\runs\updown0318\rtdetr-PConv-Rep+Pola+Focaler-MPDIoU\weights\best.pt'
    model = RTDETR(model_path) # 选择训练好的权重路径
    result = model.val(data='datasets/data5.yaml',
                      split='val', # split可以选择train、val、test 根据自己的数据集情况来选择.
                      imgsz=640,
                      batch=4,
                      save_json=True, # if you need to cal coco metrice
                      project='expdata',
                      name=r'updown0318\E:\RTDETR-main\rtdetr-PConv-Rep+Pola',
                      )
